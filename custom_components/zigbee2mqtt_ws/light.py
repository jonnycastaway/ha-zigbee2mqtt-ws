...
class Z2MLight(Z2MEntity, LightEntity):
    ...
    def is_on(self) -> bool | None:
        ...
        if state is None:
            return None
        # Z2M sends "ON" or "OFF" - handle case-insensitive
    ...
    def color_mode(self) -> ColorMode | None:
        ...
        z2m_mode = self._get_state_value("color_mode")
        
        # Map Z2M color_mode to HA ColorMode
        if z2m_mode == "hs" or z2m_mode == "hue":
            # HS is not supported in HA 2026+, map to XY or COLOR_TEMP
        ...
        if z2m_mode == "color_temp":
            if ColorMode.COLOR_TEMP in self._attr_supported_color_modes:
                return ColorMode.COLOR_TEMP
        
        # Fallback: check color dict
        ...
        # HA 2026+ requires a valid color_mode - fallback to first supported
